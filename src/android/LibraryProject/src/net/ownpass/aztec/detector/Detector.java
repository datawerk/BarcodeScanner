...
package net.ownpass.aztec.detector;

import net.ownpass.NotFoundException;
import net.ownpass.ResultPoint;
import net.ownpass.aztec.AztecDetectorResult;
import net.ownpass.common.BitMatrix;
import net.ownpass.common.GridSampler;
import net.ownpass.common.detector.MathUtils;
import net.ownpass.common.detector.WhiteRectangleDetector;
import net.ownpass.common.reedsolomon.GenericGF;
import net.ownpass.common.reedsolomon.ReedSolomonDecoder;
import net.ownpass.common.reedsolomon.ReedSolomonException;
