...
import net.ownpass.client.android.CaptureActivity;
...
import net.ownpass.client.android.wifi.WifiConfigManager;
import net.ownpass.client.result.ParsedResult;
import net.ownpass.client.result.WifiParsedResult;
