...
package net.ownpass.client.android.result.supplement;
...
import net.ownpass.client.android.common.executor.AsyncTaskExecInterface;
import net.ownpass.client.android.common.executor.AsyncTaskExecManager;
import net.ownpass.client.android.history.HistoryManager;
import net.ownpass.client.result.ISBNParsedResult;
import net.ownpass.client.result.ParsedResult;
import net.ownpass.client.result.ProductParsedResult;
import net.ownpass.client.result.URIParsedResult;
