...
package net.ownpass.multi.qrcode.detector;
...
import net.ownpass.qrcode.detector.FinderPattern;
import net.ownpass.qrcode.detector.FinderPatternFinder;
import net.ownpass.qrcode.detector.FinderPatternInfo;
